...
export default function FaultyTerminal({
  ...
  mouseReact = true,
  mouseStrength = 0.2,
  // `dpr` must not access `window` at module-import time (SSR). Compute the
  // effective DPR at runtime inside the component instead.
  ...
  // Safe device pixel ratio: fallback to 1 during SSR
