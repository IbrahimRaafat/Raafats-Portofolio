...
const MenuItem: React.FC<MenuItemProps> = ({
  ...
  return (
    <div
      className="relative overflow-hidden text-center min-h-[105px] md:min-h-[120px] lg:min-h-[150px]"
      ref={itemRef}
    ...
    >
      ...
      <div
        ...
        ref={marqueeRef}
        style={{ backgroundColor: marqueeBgColor, transform: 'translateY(101%)' }}
      >
        <div className="h-full w-fit flex" ref={marqueeInnerRef}>
          {[...Array(repetitions)].map((_, idx) => (
            <div className="marquee-part flex items-center flex-shrink-0" key={idx} style={{ color: marqueeTextColor }}>
              ...
              <div
                className="w-[500px] h-[18vh] my-[2em] mx-[2vw] py-[1em] bg-contain bg-no-repeat bg-center"
